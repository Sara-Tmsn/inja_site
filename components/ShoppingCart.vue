<template>
  ...
  >
    ...
    <v-card style="overflow: auto; height: 100%; padding: 16px !important">
      <div class="fill-height">
        ...
        >
          <v-col cols="12">
            <v-row justify="center" class="mb-4 mx-4">
              <img src="../static/shopping-cart.png" width="100px"/>
            </v-row>
        ...
        <div v-else>
          ...
          <v-expansion-panels accordion flat multiple>
            <v-expansion-panel>
              <v-expansion-panel-header
                class="text-body-2 font-weight-bold pa-0"
              >
                کد تخفیف دارید؟
          ...
          <v-row no-gutters justify="space-around" class="my-1 mr-4">
          ...
          <v-row no-gutters class="pa-0" align="center" justify="center">
            <v-btn
              color="#0095F6"
              block
              class="btn white--text"
